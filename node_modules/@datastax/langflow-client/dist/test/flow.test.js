...
describe("Flow", () => {
    ...
    describe("uploadFile", () => {
        it("reads the file and sends it to the server", async () => {
            const fetcher = createMockFetch({ flowId, file_path: "folder/date-filename.jpg" }, (input, init) => {
            ...
            const flow = new Flow(client, flowId);
            const result = await flow.uploadFile(join(import.meta.dirname, "fixtures", "bodi.jpg"));
